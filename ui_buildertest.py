...
#
# Created: Sun Apr 27 13:23:37 2014
...
class Ui_BuilderTest(object):
    def setupUi(self, BuilderTest):
        ...
        BuilderTest.resize(247, 81)
        self.buttonBox = QtGui.QDialogButtonBox(BuilderTest)
        self.buttonBox.setGeometry(QtCore.QRect(60, 40, 171, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName(_fromUtf8("buttonBox"))
        self.layerCombo = QtGui.QComboBox(BuilderTest)
        self.layerCombo.setGeometry(QtCore.QRect(10, 10, 221, 24))
